...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 12-Jun-2018 às 01:35
...
INSERT INTO `aviao` (`id`, `nome`, `lugares`, `lugares_disponiveis`) VALUES
(2, 'Malasia Airlines 355', 2, 3);
...
(8, 'Salatiel Domingues', '2018-06-15', 'Américas', 15632, 2, b'1'),
(6, 'luiz miguel jarduli leite', '2018-06-13', 'Jabuticabal', 123, 2, b'1'),
(7, 'Ateu de jesus', '2018-06-13', 'igreja', 12, 2, b'1');
COMMIT;

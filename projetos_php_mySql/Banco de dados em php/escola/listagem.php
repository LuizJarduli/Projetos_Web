...
<div class="card" style="width: 18rem;float: left;margin: 0 2rem 0 20rem;">
  <img class="card-img-top" src="img/alunos.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Alunos</h5>
    <a href="listalunos.php" class="btn btn-primary">Ir <i class="far fa-arrow-alt-circle-right"></i></a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <a href="listcursos.php" class="btn btn-primary">Ir <i class="far fa-arrow-alt-circle-right"></i></a>
  </div>
</div>
</div>
</body>

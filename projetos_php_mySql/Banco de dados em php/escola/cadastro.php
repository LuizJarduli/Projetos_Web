...
<div class="card" style="width: 18rem;float: left;margin: 0 2rem 0 20rem;">
  ...
  <div class="card-body">
    ...
    <a href="cadaluno.php" class="btn btn-primary">Ir <i class="far fa-arrow-alt-circle-right"></i></a>
  </div>
</div>
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <a href="cadcurso.php" class="btn btn-primary">Ir <i class="far fa-arrow-alt-circle-right"></i></a>
  </div>
</div>
</div>
</body>
